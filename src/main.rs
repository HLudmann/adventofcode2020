...
fn main() {
    ...
    match matches.value_of("DAY").unwrap_or("0") {
        "0" => {
            ...
            println!("");
            println!("D16P1: {}", day16::puzzle1());
            println!("D16P2: {}", day16::puzzle2());
            println!("");
            println!("D17P1: {}", day17::puzzle1());
            println!("D17P2: {}", day17::puzzle2());
        }
        "1" => {
        ...
        "17" => {
            println!("P1: {}", day17::puzzle1());
            println!("P2: {}", day17::puzzle2());
        }
